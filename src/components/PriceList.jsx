      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className={`grid md:grid-cols-2 gap-6 items-start`}>
          {data?.map((plan, index) => {
            ...
            return (
              <div
                key={index} // Jangan lupa tambahkan key prop
                className={`
                    ...
                    <ul className="space-y-3 px-6">
                      {plan.features.slice(0, 4).map((item, i) => (
                        <li key={i} className="flex items-start gap-3">
                          ...
                          <span className="text-gray-700 group-hover:text-white dark:text-white/70 text-sm transition-colors font-semibold dark:group-hover:text-neutral-700 font-semibold">
                            {item.feature}
                          </span>
                        </li>
                      ))}
