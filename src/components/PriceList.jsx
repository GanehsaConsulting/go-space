        ...
        <div className={`grid md:grid-cols-2 gap-6 items-start`}>
          {data?.map((plan, index) => {
            ...
            return (
              <div
                key={`price-id-${index}`}
                className={`group relative overflow-hidden rounded-[37px] cursor-pointer relative duration-700 transition-colors ${bgMainDarkGradient}`}
              >

                <div className="absolute -right-4 top-15 bg-goYellow text-goYellow text-6xl blur-[75px] " >lorem <br /> ipsum</div>
