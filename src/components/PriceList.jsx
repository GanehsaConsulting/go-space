          ...
          <div className={`grid md:grid-cols-2 gap-6 items-start`}>
            {data?.map((plan, index) => {
              ...
              return (
                <div
                  key={`price-id-${index}`}
                  className={`group  rounded-[37px] cursor-pointer relative duration-700 transition-colors ${bgNeutralGradient}`}
                >
                  ...
                  <div className="mt-6 mb-6 px-6 space-y-3">
                    <Badge className={"bg-purple-500/10 border-purple-900/70 text-purple-950 px-4 py-1 group-hover:text-white dark:text-white group-hover:border-white group-hover:bg-white/10 dark:group-hover:bg-neutral-500 "}  >1 Year</Badge>
                  ...
                  <div>
                        ...
                        <ul className="space-y-3 mt-3">
                          {plan.features.slice(4).map((item, i) => (
                            <li key={i + 4} className="flex items-start gap-3 ">
                              ...
                              <span className="text-gray-700 group-hover:text-white dark:text-white text-sm transition-colors dark:group-hover:text-neutral-700">
                                {item.feature}
                              </span>
                            </li>
                          ))}
                    ...
                    {hasMoreFeatures && (
                      <button
                        ...
                        className="px-6 mt-4 flex items-center gap-2 text-sm font-semibold text-neutral-600 group-hover:text-white dark:text-white transition-all duration-300 hover:gap-3 dark:group-hover:text-neutral-500 italic"
                      >
                        {isExpanded ? (
                          <>
                            See Less
                    ...
                    <a
                      href={plan.link}
                      target="_blank"
                      className="mt-6 mx-3 flex items-center justify-between bg-neutral-900 dark:bg-white group-hover:bg-white/90 py-2 px-3 ps-6 rounded-full mb-4 tra3nsition-colors dark:group-hover:bg-neutral-900"
                    >
                      <div className="text-white dark:text-neutral-900 group-hover:text-neutral-900 font-semibold dark:group-hover:text-white">
                        Book Now
                      </div>
                      <div className="bg-white dark:bg-neutral-900 text-neutral-900 group-hover:bg-neutral-900 group-hover:text-white dark:text-white p-2 rounded-full dark:group-hover:bg-white ">
                        <GoArrowUpRight className="text-lg dark:group-hover:text-neutral-900" />
                      </div>
                    </a>
                  </div>
                </div>
