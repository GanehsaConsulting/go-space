    ...
    <section className="bg-neutral-200/70 dark:bg-linear-to-br dark:from-neutral-800 dark:to-neutral-900 py-12">
      ...
      >
        {data.map((item, index) => (
          <div
            key={index}
            className="snap-start min-w-60 h-80 bg-white dark:bg-neutral-900 dark:hover:bg-white  hover:bg-neutral-800 p-5 rounded-2xl flex flex-col justify-between group transition duration-800 cursor-pointer drop-shadow-destructive dark:border-white/20 dark:border"
          >
